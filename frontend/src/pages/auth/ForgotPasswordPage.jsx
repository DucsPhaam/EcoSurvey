        ...
        <div className="bg-white border-[3px] border-earth-ink p-8 shadow-[6px_6px_0px_#1a1a1a]">
          {sent ? (
            <div className="text-center">
              ...
              <h2 className="font-display text-2xl uppercase text-earth-ink mb-3">Email đã gửi!</h2>
              <p className="text-sm text-earth-ink/70 leading-relaxed mb-2">
                Nếu địa chỉ <strong>{email}</strong> có trong hệ thống, bạn sẽ nhận được email
                hướng dẫn đặt lại mật khẩu trong vài phút.
              </p>
              <p className="text-xs text-earth-ink/50 mb-6">
                Liên kết có hiệu lực trong <strong>15 phút</strong>. Kiểm tra hộp thư spam nếu không thấy.
              </p>
              <button
            ...
            <>
              <div className="mb-6">
                ...
                <h2 className="font-display text-3xl uppercase mt-1">Quên mật khẩu</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                <div>
                  <label htmlFor="fp-email" className="label">Địa chỉ Email</label>
